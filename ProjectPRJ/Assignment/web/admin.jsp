...
<html>
    ...
    <body>
                    ...
                    <tr>
                        ...
                        <td style="width: 17%">
                            <div style="display: flex; justify-content: space-around; background-color: white; border-radius:10px ">
                                ...
                                <div style="margin: 5px ;">
                                    <a ref="#" onclick="doDelete('${o.proId}')" style="color: red;; font-weight: bolder ; font-family: 'Eczar', serif; cursor: pointer">Delete</a>
                                </div> 
                            </div>  
                        </td>
        ...
        <script>
            ...
            function doDelete(proId) {
                if (confirm("Are you sure you want to delete this product?")) {
                    window.location.href = "delete?proId" + proId;
                }
            }
