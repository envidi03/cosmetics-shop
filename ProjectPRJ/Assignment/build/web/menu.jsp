...
<div class="wel">
    ...
    <c:if test="${sessionScope.account.role ==1 || sessionScope.account== null}">
        <h6 href="">Welcome to our shop</h6>
    </c:if>
...
<div class="topnav">
    ...
    <div class="topnav-centered">
        <a href="home" ><strong><img style="width: 70%;" src="img/DOHU.jpg"></strong></a>
    </div>

    <!-- Left-aligned links (default) -->
    <a href="shopall" style="font-size: 25px">Shop All</a>
    <a href="collection?coId=1" style="font-size: 25px">Collection</a>
    <a href="bestseller" style="font-size: 25px">Best Sellers</a>

    <!-- Right-aligned links -->
    <div class="topnav-right" style="display: flex; margin-right: 20px">
